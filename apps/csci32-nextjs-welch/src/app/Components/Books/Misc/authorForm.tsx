...
import { CreateAuthorProps, createAuthor, updateAuthor } from '../../../hook/useAuthors'
...
export default function AuthorForm() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    setAuthorFormData({ author_name: '', author_description: '', flag: false })
    setBookProperties([
      {
        book: {
          book_name: '',
    ...
    <div>
      ...
      <form className="flex flex-col gap-4 " onSubmit={handleSubmit}>
        ...
        <Flex className="justify-end gap-2 ">
          <Button variant={Variants.Secondary} onClick={addBook}>
            Add Another Book
          </Button>
          <Button type="submit" variant={Variants.Secondary}>
            Submit
          </Button>
        </Flex>
      </form>
